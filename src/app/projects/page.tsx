    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-1">
        <section id="projects" className="min-h-screen">
          <div className="py-20 px-4 md:px-16 relative z-10 w-full bg-black-100">
            <div className="text-center mb-16">
              <ScrollReveal textClassName="text-4xl md:text-5xl font-bold text-white mb-6" baseOpacity={0.2} baseRotation={2}>
                My Recent Projects
              </ScrollReveal>

              <ScrollReveal textClassName="text-lg md:text-xl text-white-100 max-w-3xl mx-auto leading-relaxed" baseOpacity={0.3} baseRotation={1}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 justify-center items-center">
              ...
              <div className="flex flex-col items-center lg:items-end">
                <h3 className="text-2xl font-bold text-white mb-24 self-start lg:self-end pr-24">Client Reviews</h3>
                <CardStack
                  items={[
                    {
                      id: 1,
            ...
            <div className="text-center">
              <ScrollReveal textClassName="text-base md:text-lg text-white-100 mb-8" baseOpacity={0.3} baseRotation={1}>
